...
See the [documentation](https://docs.influxdata.com/influxdb/v2/reference/config-options/) for a complete list of InfluxDB OSS v2's config options that you can put in `influxdb_environment_variables_additional_variables`.
